	...
	return types.ProviderConfig{
		...
		Models: types.ProviderModels{
			...
			Capabilities: map[string]types.ModelCapabilities{
				...
				"llama-3.3-70b-versatile":                   {StructuredOutputs: strPtr("none"), Logprobs: boolPtr(false)},
	...
	return types.ProviderConfig{
		...
		Models: types.ProviderModels{
			...
			Capabilities: map[string]types.ModelCapabilities{
				...
				"openai.gpt-oss-120b":          {StructuredOutputs: strPtr("none"), Logprobs: boolPtr(true)},
				"openai.gpt-oss-20b":           {StructuredOutputs: strPtr("none"), Logprobs: boolPtr(true)},
				"meta.llama-3.3-70b-instruct":  {Logprobs: boolPtr(true)},
			},
		},
		Capabilities: types.ProviderCapabilities{
			Streaming:           true,
