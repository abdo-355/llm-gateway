...
var tierRegistry = map[types.Tier]types.TierConfig{
	types.TierDefault: {
		...
		Entries: []types.TierEntry{
			...
			{Provider: "tokenharbor", Model: "qwen3.8-27b:free", Weight: 0.87},
			...
			{Provider: "bai", Model: "deepseek-v4-flash", Weight: 0.85},
			{Provider: "tokenharbor", Model: "deepseek-v4-flash:free", Weight: 0.85},
			...
			{Provider: "tokenharbor", Model: "mimo-v2.5:free", Weight: 0.77},
	...
	types.TierPro: {
		...
		Entries: []types.TierEntry{
			...
			{Provider: "bai", Model: "deepseek-v4-flash", Weight: 0.89},
			{Provider: "tokenharbor", Model: "deepseek-v4-flash:free", Weight: 0.89},
			...
			{Provider: "tokenharbor", Model: "qwen3.8-27b:free", Weight: 0.86},
	...
	types.TierMax: {
		...
		Entries: []types.TierEntry{
			...
			{Provider: "bai", Model: "deepseek-v4-flash", Weight: 0.90},
			{Provider: "tokenharbor", Model: "deepseek-v4-flash:free", Weight: 0.90},
			...
			{Provider: "tokenharbor", Model: "qwen3.8-27b:free", Weight: 0.83},
			...
			{Provider: "ollama", Model: "minimax-m3", Weight: 0.77},
