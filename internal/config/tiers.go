...
var tierRegistry = map[types.Tier]types.TierConfig{
	...
	types.TierPro: {
		...
		Entries: []types.TierEntry{
			...
			{Provider: "kilo", Model: "stepfun/step-3.7-flash:free", Weight: 0.84},
			...
			{Provider: "opencode", Model: "deepseek-v4-flash-free", Weight: 0.72},
			{Provider: "opencode", Model: "mimo-v2.5-free", Weight: 0.70},
			{Provider: "opencode", Model: "big-pickle", Weight: 0.68},
			{Provider: "openrouter", Model: "nvidia/nemotron-3-super-120b-a12b:free", Weight: 0.64},
			{Provider: "kilo", Model: "poolside/laguna-m.1:free", Weight: 0.62},
	...
	types.TierMax: {
		...
		Entries: []types.TierEntry{
			...
			{Provider: "kilo", Model: "nvidia/nemotron-3-ultra-550b-a55b:free", Weight: 0.64},
			{Provider: "cohere", Model: "command-a-03-2025", Weight: 0.60},
			{Provider: "kilo", Model: "poolside/laguna-m.1:free", Weight: 0.58},
		},
		SLO: &types.TierSLO{
